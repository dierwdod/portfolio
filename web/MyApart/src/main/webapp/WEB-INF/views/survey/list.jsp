...
<head>
	...
	<script>		
		function doParticipation(arg){
			if(confirm("참여하시겠습니까?")==true){
				location.href="/MyApart/survey/contents?no="+arg;
			}
			else{
				return
			}
		...
		<div class="board_contents">
			<div class="contents_top">
				<div id="contents_top_list">
					<a href="/MyApart/survey/list?mode=noparti">미참여 설문 목록</a>
			...
			<div class="contents_middle">
				...
				<% 
					...
					if(listMode.equals("list") || listMode.equals("noparti")){
				%>
						<th width="7%">NO</th>
						<th width="49%">제목</th>
						<th width="10%">글쓴이</th>
					...
					%>						
							...
							<% if(end_date.compareTo(today) < 0){ %>
								<td>[마감]</td>						
							<% } else { %>	
								<td><a href='javascript:doParticipation(<%=survey.getSurNum()%>)'>[참여]</a></td>
							<% } %>	
							</tr>
